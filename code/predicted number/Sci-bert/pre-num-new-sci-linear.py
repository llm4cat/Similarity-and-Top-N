...
with open('model_performance_scibert_linear.txt', 'w') as f:
...
results_df.to_csv('label_count_predictions_scibert_linear.csv', index=False, encoding='utf-8-sig')

# Save trained XGBoost model
joblib.dump(reg, 'scibert_linear_model.pkl')
