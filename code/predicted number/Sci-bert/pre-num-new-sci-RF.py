...
with open('model_performance_scibert_rf.txt', 'w') as f:
...
results_df.to_csv('label_count_predictions_scibert_rf.csv', index=False, encoding='utf-8-sig')

# Save trained XGBoost model
joblib.dump(reg, 'scibert_rf_model.pkl')
